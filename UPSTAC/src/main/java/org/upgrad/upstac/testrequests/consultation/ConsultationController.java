...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        List<TestRequest> findByDoctor(LAB_TEST_COMPLETED);
        ...
        throw new ResponseStatusException(HttpStatus.NOT_FOUND,"Lab test not completed");
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        myObj2 = userLoggedInService.getLoggedInUser();
        myObj2 = <TestRequest> getForDoctor();
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        User myObj3 = new User();
        myObj3 = userLoggedInService.getLoggedInUser();
        myObj3 = <TestRequest> getForConsultations();
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        User myObj4 = new User();
        myObj4 = userLoggedInService.getLoggedInUser();
        myObj4 = <TestRequest> updateConsultation();
