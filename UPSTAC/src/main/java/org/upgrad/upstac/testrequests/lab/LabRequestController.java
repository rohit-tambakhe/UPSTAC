...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User myObj = new User();
        myObj = userLoggedInService.getLoggedInUser();
        myObj = <TestRequest> getForTester();
        ...
        throw new ResponseStatusException(HttpStatus.NOT_FOUND,"Not found"); // replace this line with your code
